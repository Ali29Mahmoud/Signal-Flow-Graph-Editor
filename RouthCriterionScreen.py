...
def get_input(screen):
    ...
    input_rect = pygame.Rect(pygame.display.Info().current_w // 2 - 300, pygame.display.Info().current_h // 2 - 250, 600, 30)
    while True:
...
def RouthScreen():
    ...
    stabilityCheck = Button(image=pygame.image.load("assets/GTF Rect.png"), pos=(650, 400), 
                            text_input="CHECK FOR STABILITY", font=get_font(20), base_color="#d7fcd4", hovering_color="White")
    
    insertEquation = Button(image=pygame.image.load("assets/EQN Rect.png"), pos=(650, 300), 
                            text_input="ADD CHARACTERISTIC EQUATION", font=get_font(20), base_color="#d7fcd4", hovering_color="White")
    ...
    while True:
        ...
        text_surface1 = get_font(20).render(result, True, white)
        text_rect1 = text_surface1.get_rect()
        text_rect1.center = (dims[0] // 2, dims[1] // 2 + 300)
